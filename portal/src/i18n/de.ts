export const de = {
  ...
  contacts: {
    ...
    referenceBody:
      'Die SB-Nummer steht im Portal unter dem Namen der Person, zum Beispiel „10/1335.21“. Wählen Sie den Zweig — die Zahl vor dem Schrägstrich — und tippen Sie den Rest. Die andere Person bekommt eine Anfrage und entscheidet selbst.',
    branchLabel: 'Zweig',
    branchNone: 'Kein Zweig',
    branchOption: 'Zweig {{branch}}',
